...
public class Attendance_V1 extends JFrame {
    ...
    static public final int height = 200; //Height of box
...
//        contents.add(image);
   //     contents.add(new JLabel(new ImageIcon("610logo.png")));
    ...
    //   contents.setLayout(layout);
        ...
        contents.add(title);
        badName.setForeground(Color.white); // Makes the titlelabel white
        title.setForeground(Color.white); // Makes the titlelabel white
        ...
        nameBox.addKeyListener(new KeyListener() {         //Checks if the enter key is pressed, if it is the entry is put into nameEntry, and the text is erased
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    for (int i = 0; i < 44; i++) {
                        nameEntry = nameBox.getText().toLowerCase();
                        
                        

                        if (nameEntry.contains(teamList[i].toLowerCase())) {
                            nameMatches = true;
