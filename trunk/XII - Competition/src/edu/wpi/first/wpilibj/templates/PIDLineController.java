 ...
 * PIDOutput
 */
public class PIDLineController implements IUtility{
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDLineController m_controller;

        public PIDTask(PIDLineController controller) {
            if (controller == null) {
                throw new NullPointerException("Given PIDLineController was null");
            }
     ...
     */
    public PIDLineController(double Kp, double Ki, double Kd,
