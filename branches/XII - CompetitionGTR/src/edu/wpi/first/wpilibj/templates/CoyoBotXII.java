...
public class CoyoBotXII extends IterativeRobot {
    ...
    public void updateDS() {
        try {
            ...
            dsLCD.println(DriverStationLCD.Line.kUser5, 1, "LineFol: " + pidLineError.pidGet() + "          ");
            ...
            switch(autoSwitch){
                case 1:
                    dsLCD.println(DriverStationLCD.Line.kMain6, 1, "Auto: " + "Disabled       ");
                    break;
                case 2:
                    dsLCD.println(DriverStationLCD.Line.kMain6, 1, "Auto: " + "1 tube, line   ");
                    break;
                case 3:
                    dsLCD.println(DriverStationLCD.Line.kMain6, 1, "Auto: " + "1 tube, d/r    ");
                    break;
                case 4:
                    dsLCD.println(DriverStationLCD.Line.kMain6, 1, "Auto: " + "2 tubes, l rack");
                    break;
                case 5:
                    dsLCD.println(DriverStationLCD.Line.kMain6, 1, "Auto: " + "2 tubes, r rack");
                    break;
            }
