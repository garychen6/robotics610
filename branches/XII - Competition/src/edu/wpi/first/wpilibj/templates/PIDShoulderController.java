 ...
 * PIDOutput
 */
public class PIDShoulderController implements IUtility{
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDShoulderController m_controller;

        public PIDTask(PIDShoulderController controller) {
            if (controller == null) {
                throw new NullPointerException("Given PIDShoulderController was null");
            }
     ...
     */
    public PIDShoulderController(double Kp, double Ki, double Kd,
