...
public class DataBaseClient {
    ...
    PriorityQueue<TeamSheet> pq;

    DataBaseClient(String path) {
        this.path = path;
        teamSheets = new HashMap();
        matchSheets = new HashMap();
        Comparator<TeamSheet> comparator = new TeamComparator();
        pq = new PriorityQueue(10, comparator);
    }
    ...
    public void updateRankings() {
        pq.addAll(teamSheets.values());
    }

    public PriorityQueue<TeamSheet> getRankings() {
        return pq;
    }
