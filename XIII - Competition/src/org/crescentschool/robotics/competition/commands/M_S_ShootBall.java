...
//        if (Buttons.isHeld(InputConstants.kR2Button, OI.getInstance().getOperator())) {
        ...
        if (!intake.isShooting()) {
            if (OI.getInstance().getDriver().getRawButton(InputConstants.kR1Button)) {
                intake.setIntakeReverse(1);
            } else if (OI.getInstance().getDriver().getRawButton(InputConstants.kL1Button)) {
                intake.setIntakeReverse(-1);;
            } else if (OI.getInstance().getOperator().getRawButton(InputConstants.kL1Button)) {
                feeder.setFeeder(-0.7);
                intake.setIntakeReverse(1);;
            } else if (OI.getInstance().getOperator().getRawButton(InputConstants.kR1Button)) {
                intake.setIntakeReverse(1);;
            } else {
